I am a scientist trained in [phonology](https://en.wikipedia.org/wiki/Phonology), [computational linguistics](https://en.wikipedia.org/wiki/Computational_linguistics), [linguistic fieldwork](https://en.wikipedia.org/wiki/Language_documentation), and [language teaching](https://en.wikipedia.org/wiki/Language_education). My current research is funded by the [Swiss National Science Foundation (SNSF)](https://www.snf.ch](https://data.snf.ch/grants/grant/186841) and focuses on [language evolution](https://www.unine.ch/evolang/home.html).
